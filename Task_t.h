...
public:
    ...
    std::atomic<bool> in_process;               // flag signolize that some work with object data in process / флаг сигнализиоует, если с объектом идет какая-то работа
...
public:
    ...
    /*@brief set work status of task
     * установдение статуса работы задачи
    */
